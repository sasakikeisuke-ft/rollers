class OptionType < ActiveHash::Base
  self.data = [
    ...
    { id: 22, type: 'numericality', info: '上限下限を設定する',
      code: 'numericality: { greater_than_or_equal_to: 数値, less_than_or_equal_to: 数値, message: ', message_ja: 'は数値が範囲外です。', message_en: ' is out of setting range' },
    { id: 23, type: 'numericality', info: '上限のみを設定する', code: 'numericality: { less_than_or_equal_to: 数値, message: ',
      message_ja: 'は数値が範囲外です。', message_en: ' is out of setting range' },
    { id: 24, type: 'numericality', info: '下限のみを設定する', code: 'numericality: { greater_than_or_equal_to: 数値, message: ',
      message_ja: 'は数値が範囲外です。', message_en: ' is out of setting range' },
    { id: 25, type: 'numericality', info: '未選択状態での禁止', code: 'numericality: { other_than: 0, message: ', message_ja: 'を選択してください',
      message_en: "can't be blank" },
